        ...
        <div className="container-custom relative">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-foreground/80 leading-relaxed">
              Have questions or feedback? We're here to help you make your home better.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
            ...
            {ContactInfo.map((item, index) => (
              ...
              >
                <div className="w-16 h-16 rounded-2xl bg-doit-50 flex items-center justify-center mb-6 group-hover:bg-doit-100 transition-colors">
                  <item.icon className="text-doit-600 group-hover:text-doit-700 transition-colors" size={28} />
                </div>
                <h3 className="text-xl font-semibold mb-3 text-doit-900">{item.title}</h3>
                <p className="text-foreground/90 font-medium mb-2">{item.content}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 mt-24">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-bold mb-8 text-doit-900">Common Questions</h2>
