  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="flex-1 flex flex-col md:flex-row">
        <div className="md:w-1/2 p-10 md:p-16 flex items-center justify-center bg-gradient-to-t md:bg-gradient-to-l from-doit-500/90  to-doit-200/80">
          <div
            className="mt-10 w-full max-w-md z-10 px-6 py-8 rounded-xl shadow-xl border border-white/40 relative overflow-hidden bg-transparent"
            style={{
          ...
          >
            <div className="mb-8 text-center md:text-left">
              <h2
                className="text-2xl font-bold mb-2 mt-[10px]"
            ...
            <p
              className="mt-6 text-center md:text-left text-sm text-foreground/70"
        ...
        <div className="md:w-1/2 bg-gradient-to-b md:bg-gradient-to-r from-doit-500/90 to-orange-500/80 p-10 md:p-16 flex items-center justify-center">
